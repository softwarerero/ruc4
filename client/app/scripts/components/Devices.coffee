  ...
  @view: () ->
    [
      m 'div', {class: 'devices'}, [
        ...
        m 'table', {class: 'pure-table', style: 'margin-top: 20px'}, [
          m 'tbody', [
...
#            row "<i class='fa fa-linux fa-2x'></i>", 'Descargar para LINUX', '#'
#            row "<i class='fa fa-apple fa-2x'></i>", 'Descargar para Mac OS X', '#'
#            row "<i class='fa fa-windows fa-2x'></i>", 'Descargar para Windows', '#'
          ]
        ]
      ]
    ]
