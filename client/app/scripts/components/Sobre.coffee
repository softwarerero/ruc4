...
module.exports = class Sobre
  ...
  @view: (ctrl) ->
    [
      ...
      m 'h4', 'Código Abierto'
      m 'p', m.trust 'El código fuente esta disponible bajo la licencia <a href="http://mit-license.org/">MIT</a> <a href="https://github.com/softwarerero/ruc4">aquí</a>.
            La versión 1.1 está en Bitbucket, separado por <a href="https://bitbucket.org/softwarerero/ruc-front">frontend</a> y el <a href="https://bitbucket.org/softwarerero/ruc-back">backend</a>.'
