  ...
  @view: (ctrl) ->
    [
      m 'div', {class: 'sobre'}, [
        ...
        m 'img', {src: "#{conf.imgPath}img/ruc.png", style: ''}
        m 'h4', 'Utilizamos las sigientes herramientas y damos gracias a sus desarrolladores:'
        m 'p', m.trust 'CoffeeScript, Elasticsearch, Mithril, Node, Express, Gulp, Browserify, Mocha, Pure, Fontawesome, Cordova, Electron, Nginx'
        m 'table', {class: 'pure-table'}, [
          ...
          m 'tbody', [
            row '4.0.1', '01.02.2016', 'Portado a CoffeeScript, Node.js y Mithril'
